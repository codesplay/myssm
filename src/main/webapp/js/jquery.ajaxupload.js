...
function uploadImageScale4Center(imgObj) {
	imgObj.style.marginTop = (parseInt(imgObj.parentNode.style.height) - imgObj.height) / 2 + 'px';
	imgObj.style.marginLeft = (parseInt(imgObj.parentNode.style.width) - imgObj.width) / 2 + 'px';
}